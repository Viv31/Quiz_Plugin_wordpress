...
//echo plugins_url(); die;
  ...
  //$path_for_admin_options =  __FILE__; 
 //die;
   ...
   <br>
	...
	foreach ($categorylist as $key => $data_category) { 
		...
		<tr>
			...
			<td><a href="<?php echo plugins_url();?>/viv-quiz-plugin/update_category.php?category_id=<?php echo $data_category->id; ?>"><button class="btn btn-primary">Update</button></a></td>
			<td><a href="<?php echo plugins_url();?>/viv-quiz-plugin/delete_category.php?category_id=<?php echo $data_category->id; ?>"><button class="btn btn-danger" onclick="return confirm('Do you really want to delete this??')">Delete</button></a></td>
	</tr>		
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form action="<?php echo plugins_url();?>/viv-quiz-plugin/insert_category.php" method="POST">
  ...
  <div id="quiz_questions" class="tab-pane fade">
	...
	foreach ($categorylist as $key => $data_category) { 
		...
		?>
			...
			<td><a href="<?php echo plugins_url();?>/viv-quiz-plugin/update_questions.php?question_id=<?php echo $que_id; ?>"><button class="btn btn-primary">Update</button></a></td>
			<td><a href="<?php echo plugins_url();?>/viv-quiz-plugin/delete_questions.php?question_id=<?php echo $que_id; ?>"><button class="btn btn-danger" onclick="return confirm('Do you really want to delete this??')">Delete</button></a></td>
...
<!--Model Starts for adding Questions-->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<form action="<?php echo  plugins_url();?>/viv-quiz-plugin/insert_question.php" method="POST">
      		<div class="form-group">
      			<label>Category Name:</label>
